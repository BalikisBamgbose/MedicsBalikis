...
using Medics.Repository;
using System.Linq.Expressions;

namespace Medics.Repository.Implementations
{
    public abstract class BaseRepository<T> : IRepository<T> where T : BaseEntity, new()
    {
        protected readonly MedicsContext _context;

        protected BaseRepository(MedicsContext context)
        {
            _context = context;
        }
